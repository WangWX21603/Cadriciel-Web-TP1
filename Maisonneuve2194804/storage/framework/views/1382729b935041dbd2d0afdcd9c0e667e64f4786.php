...
<body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="<?php echo e(route('etudiant.index')); ?>">Accueil</a></li>
        ...
        <div class="py-5 bg-image-full" style="background-image: linear-gradient(#3e5151, #decba4)">
            <h1 class="display-one my-5 text-center text-white display-3">
                Bienvenue sur Notre Site <?php echo e(config('app.name')); ?>
